...
public class TroopAI_Temp : MonoBehaviour {
    ...
    private GameCode_Temp game = null;
    Vector3 pos;
    GameObject nearest;
    private TroopAI_Temp nearestAI = null;
    ...
    void Start()
    {
        ...
        game = GameObject.Find("EventSystem").GetComponent<GameCode_Temp>();
        if (type == "Cavalry")
        {
            //Debug.Log("Cavalry");
            health = 40;
    ...
    void Update()
    {
        ...
        if (activ)
        {
            if (state == (int)States.CHARGE)
            {
                ...
                for (int i = 0; i < game.objects.Count; ++i)
                {
                    nearestAI = game.objects[i].GetComponent<TroopAI_Temp>();
            ...
            if (state == (int)States.CHASE)
            {
                ...
                else
                {
                    if (nearestAI.activ)
                    {
                        ...
                        nearestAI = nearest.GetComponent<TroopAI_Temp>();
