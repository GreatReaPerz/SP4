...
public class enemyGridSystem_Temp : MonoBehaviour {
    ...
    private enemyTetrisSpawner_Temp theTetrisSpawner = null;
    bool check;
    ...
    public void Start()
    {
        ...
        //    taken[i] = false;
        //}
        theTetrisSpawner = GameObject.Find("enemySpawner").GetComponent<enemyTetrisSpawner_Temp>();
