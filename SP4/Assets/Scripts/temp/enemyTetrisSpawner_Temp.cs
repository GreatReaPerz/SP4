...
public class enemyTetrisSpawner_Temp : MonoBehaviour {
    ...
    public List<TetrisCube> tetrisList = new List<TetrisCube>(3);
    float timer = 0;
    int numSpawned = 0;
    private Vector3 pil;
    private Vector3 pil1;
    public bool SomethingIsMoving = false;
    public int IndexofMovingObject = 0;
